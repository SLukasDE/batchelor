#ifndef BATCHELOR_CONDITION_FOO_H_
#define BATCHELOR_CONDITION_FOO_H_
...
struct CObject {
    ...
    void InsertObjectList(std::vector<CObject>& aObjectList);
...
#endif /* BATCHELOR_CONDITION_FOO_H_ */
