...
#ifndef BATCHELOR_HEAD_COMMON_BUILTIN_SLAVE_H_
#define BATCHELOR_HEAD_COMMON_BUILTIN_SLAVE_H_
...
class Slave : public Plugin, public esl::object::InitializeContext {
public:
	struct Settings {
...
#endif /* BATCHELOR_HEAD_COMMON_BUILTIN_SLAVE_H_ */
