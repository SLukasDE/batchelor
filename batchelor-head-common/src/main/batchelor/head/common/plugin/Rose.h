...
#ifndef BATCHELOR_HEAD_COMMON_PLUGIN_ROSE_H_
#define BATCHELOR_HEAD_COMMON_PLUGIN_ROSE_H_
...
class Rose : public Plugin, public esl::object::InitializeContext {
public:
	struct Settings {
...
#endif /* BATCHELOR_HEAD_COMMON_PLUGIN_ROSE_H_ */
