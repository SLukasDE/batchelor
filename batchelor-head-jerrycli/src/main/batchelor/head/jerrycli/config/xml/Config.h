...
#ifndef BATCHELOR_HEAD_JERRYCLI_CONFIG_XML_CONFIG_H_
#define BATCHELOR_HEAD_JERRYCLI_CONFIG_XML_CONFIG_H_
...
#endif /* BATCHELOR_HEAD_JERRYCLI_CONFIG_XML_CONFIG_H_ */
