...
toolcontainer ./build/batchelor-worker/0.0.1/default/architecture/linux-gcc/link-executable/batchelor-worker -m CLOUD_ID GCP -C basic -s url http://localhost:8080 -s api-key AXBS5 -e batch-1 exec -s cmd /bin/sleep -s args 10 -s argrgs-flag fixed -s cd /tmp
